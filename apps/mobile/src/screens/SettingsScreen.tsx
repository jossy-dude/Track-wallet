  ...
  return (
    <MotionPage includeStyles className="space-y-6">
      <section className="space-y-6">
        <MotionPanel className="space-y-2" variant="subtle">
          <header className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-6 text-on-surface-variant">
              Everyday preferences first, with system internals clearly separated below.
            </p>
          </header>
        </MotionPanel>

        <MotionPanel
          className="relative overflow-hidden rounded-[28px] border border-outline-variant/20 bg-surface-container p-5 shadow-[0_4px_20px_rgba(46,50,48,0.06)]"
          delay={50}
          variant="hero"
        >
          <div className="tw-motion-showcase-halo pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-primary-fixed/45 blur-3xl" />
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-on-surface-variant">
                  Device profile, privacy status, and export posture for this phone.
                </p>
              </div>
            </div>
        ...
        {settingsHubSections.map((section, index) => (
          <MotionPanel className="space-y-3" delay={110 + index * 40} key={section.id}>
            <section className="space-y-3">
              <h2 className="px-1 font-headline text-lg font-semibold text-on-surface-variant">
                {section.title}
              </h2>
              <MotionStagger
                className="overflow-hidden rounded-[28px] border border-outline-variant/20 bg-surface-container-low shadow-[0_2px_10px_rgba(46,50,48,0.03)]"
                step={36}
              >
        ...
        <MotionPanel className="grid gap-4" delay={240}>
          <button
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-on-surface-variant">
              Setup, parser, security, and device guides.
            </p>
          </button>
        </MotionPanel>
      </section>
